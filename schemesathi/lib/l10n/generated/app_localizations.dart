...
abstract class AppLocalizations {
  ...
  /// No description provided for @occDailyWage.
  ///
  /// In en, this message translates to:
  /// **'Daily Wage Worker'**
  String get occDailyWage;
  ...
  /// No description provided for @analyzingSchemes.
  ///
  /// In en, this message translates to:
  /// **'Analyzing government schemes...'**
  String get analyzingSchemes;

  /// No description provided for @basedOnOfficial.
  ///
  /// In en, this message translates to:
  /// **'Based on official government documents'**
  String get basedOnOfficial;

  /// No description provided for @resultsTitle.
  ///
  /// In en, this message translates to:
  /// **'Curated Schemes for You'**
  ...
  /// No description provided for @schemeAssistantTitle.
  ///
  /// In en, this message translates to:
  /// **'Scheme Assistant'**
  String get schemeAssistantTitle;

  /// No description provided for @schemeAssistantSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Helping you apply step-by-step'**
  String get schemeAssistantSubtitle;
  ...
  /// No description provided for @quickEligible.
  ///
  /// In en, this message translates to:
  /// **'Am I eligible?'**
  String get quickEligible;

  /// No description provided for @quickDocs.
  ///
  /// In en, this message translates to:
  /// **'Required documents'**
  String get quickDocs;
  ...
  /// No description provided for @quickMistakes.
  ///
  /// In en, this message translates to:
  /// **'Common mistakes'**
  String get quickMistakes;
}
